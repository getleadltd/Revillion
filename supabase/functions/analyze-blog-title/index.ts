...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt =
      `Sei un esperto SEO e content strategist specializzato in affiliate marketing iGaming.
              ...
              parameters: {
                ...
                properties: {
                  ...
                  keywords: {
                    ...
                    maxItems: 6,
                    description:
                      "SEO keywords: primary first, then secondary, then LSI",
                  },
                  tone: {
                    type: "string",
                  ...
                  search_intent: {
                    ...
                    description:
                      "Primary search intent of users searching this title",
                  },
                  content_format: {
                    type: "string",
